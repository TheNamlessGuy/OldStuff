...
public class FireTile extends Tile{
	...
	public FireTile(int xLocation, int yLocation, boolean playerSpawn, boolean enemySpawn) throws SlickException {
	...
	public void update() {
		if (playerLocation){
			if(!PlayLevel.player.isFireResistant() && !PlayLevel.player.isInvulnerable()){
				PlayLevel.player.setBurning(true);
			}else{
