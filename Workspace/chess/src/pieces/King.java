...
public class King {
	...
	public static JButton[][] canMove(JButton[][] b, int[] location, Color[][] colors, JButton q, ImageIcon[] enemies) {
		if (location[1] != 7){
		...
		b = King.canAttack(b, enemies, location);
		if (canMoveB){
	...
	public static JButton[][] canAttack(JButton[][] b, ImageIcon[] enemies, int[] location){
		for (ImageIcon i: enemies){
			if (location[1] != 7){
				if (b[location[0]][location[1]+1].getIcon() == i){ //ATTACK EAST
					b[location[0]][location[1]+1].setBackground(Color.blue);
					canMoveB = true;
				}
			}if (location[1] != 0){
				if (b[location[0]][location[1]-1].getIcon() == i){ //WEST
					b[location[0]][location[1]-1].setBackground(Color.blue);
					canMoveB = true;
				}
			}if (location[0] != 0){
				if (b[location[0]-1][location[1]].getIcon() == i){ //NORTH
					b[location[0]-1][location[1]].setBackground(Color.blue);
					canMoveB = true;
				}
			}if (location[0] != 7){
				if (b[location[0]+1][location[1]].getIcon() == i){ //SOUTH
					b[location[0]+1][location[1]].setBackground(Color.blue);
					canMoveB = true;
				}
			}if (location[0] != 0 && location[1] != 7){
				if (b[location[0]-1][location[1]+1].getIcon() == i){ //NORTHEAST
					b[location[0]-1][location[1]+1].setBackground(Color.blue);
					canMoveB = true;
				}
			}if (location[0] != 0 && location[1] != 0){
				if (b[location[0]-1][location[1]-1].getIcon() == i){ //NORTHWEST
					b[location[0]-1][location[1]-1].setBackground(Color.blue);
					canMoveB = true;
				}
			}if (location[0] != 7 && location[1] != 7){
				if (b[location[0]+1][location[1]+1].getIcon() == i){ //SOUTHEAST
					b[location[0]+1][location[1]+1].setBackground(Color.blue);
					canMoveB = true;
				}
			}if (location[0] != 7 && location[1] != 0){
				if (b[location[0]+1][location[1]-1].getIcon() == i){ //SOUTHWEST
					b[location[0]+1][location[1]-1].setBackground(Color.blue);
					canMoveB = true;
				}
			}
